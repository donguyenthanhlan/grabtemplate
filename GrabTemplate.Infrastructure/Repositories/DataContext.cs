...
namespace GrabTemplate.Infrastructure.Repositories
{
    public class DataContext : DbContext, IDataContextAsync
    {
        ...
        public DataContext(DbContextOptions<GrabTemplateContext> options) : base(options)
        {
        ...
        public DataSet ExecuteStoredProcedure(string sqlCommandText, IList<NpgsqlParameter> parameters)
        {
